...
#ifndef IMAGE_HANDLER__DOWNLOAD_CACHE__SWIFT_H
#define IMAGE_HANDLER__DOWNLOAD_CACHE__SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Image_Handler__Download_Cache_",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
